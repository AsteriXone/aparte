 ...
 * ImageOrla
 *
 * @ORM\Table(name="image_orla_provisional")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ImageOrlaRepository")
 * @Vich\Uploadable
 */
class ImageOrla
{
     ...
     *
     * @Vich\UploadableField(mapping="orla_image", fileNameProperty="imageName")
     *
     * @var File
     */
    private $imageFile;
